...
<section id="about" class="about section">
        <div class="container">
            ...
            <h2 class="title text-center">Vad gör vi mer?</h2>
            <p class="intro text-center">Vi kommer också jobba mer aktivt med att gräva djupare i tips som vi får och gå igenom hur saker och ting skulle kunna fungera bättre.</p>
